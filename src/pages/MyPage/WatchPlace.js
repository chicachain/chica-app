...
export default React.memo(function WatchPlace(props) {
  ...
  const getSearchResult = async pageNo => {
    ...
    try {
      ...
      const { data } = await getFavoriteShopList(params);
    ...
    <main id="watch-list">
      ...
      <Container className="container-custom" id="scrollableDiv">
        <div className="tab-menu">
          <Button className="active" onClick={place}>
            플레이스{' '}
                ...
                searchResult.map((result, index) => (
                  <div className="menu-box" key={index}>
                    ...
                    <div className="menu-fontbox">
                      <div>
                        <p className="menu-title">{result.shopNm}</p>
                        <p className="watch-text">{result.text}</p>
